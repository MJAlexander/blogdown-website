...
As someone who uses social media data in research, it's always in the back of my mind that the data  obtained from social media websites are constantly in flux: user bases change, company goals change, budgetary considerations change. Meta, for example, could just decide one day to remove the potential reach numbers from the Facebook Advertising Platform with paying, which would completely undermine this area of research. 
