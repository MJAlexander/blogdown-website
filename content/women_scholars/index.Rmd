...
d1 <- reactable(df  %>% rename(`Sub-discipline` = Category) %>% select(-page, -paper_1_link, -paper_2_link), 
...
#htmlwidgets::saveWidget(d1, file = "d1.html")

```

<!-- <iframe seamless src="d1.html" width="100%" height="700"></iframe> -->
