...
$$
where the $Y_{.x}$'s are the principal components above and the $\beta$'s are to be estimated. Using the sliders below you can see how different coefficients and linear combinations of the principal components above lead to different shaped mortality curves. 


```{r, echo=FALSE, fig.width= 10}


knitr::include_app("http://shiny.demog.berkeley.edu/monicah/mort/",  height = "600px")
