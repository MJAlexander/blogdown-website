---
title: "Comparing methods for smoothing temporal demographic data, and the distortr package"
author: "Monica Alexander"
date: "2017-10-31"
output: html_document
---
At the International Population Conference of the International Union for the Scientific Study of Population (IUSSP) I will present work on comparing different methods from smoothing demographic data. This post briefly outlines the motivation for the project and describes the R package `distortr` which accompanies the project. 
...
In such situations, demographers often employ statistical models to help estimate and understand underlying trends. Often, these statistical models have the same general form:
...
While the inclusion of covariates and regression framework is often well justified, the choice for modeling the distortions $Z_t$ is often more arbitrary. However, models for $Z_t$ are important: they allow for data-driven trends that may not be captured by simple regression models; they express these distortions in a smooth way, accounting for error in data observations; they incorporate uncertainty in the underlying processes; and allow for a temporal mechanism to be projected into the future. Different model choice can sometimes lead to vastly different estimates.

<img src="/img/compbol.png">

This project aimed to compare three main families of models for temporal distortions: 
...
This part of the package contains tools to investigate how different models performed in different simulation settings and how much it matters if we pick the 'wrong' model. 
