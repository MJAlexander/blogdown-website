...
Opioid-related mortality in the United States has been rising steadily since 2000. The opioid mortality rate more than tripled since over the fifteen year period 2000--2015, and shows no signs of declining --- in fact, the rate of increase has accelerated in recent years. This is unique to opioid-related drug deaths, with the non-opioid mortality rate remaining fairly level since 2005. The so-called 'opioid epidemic' has gained national attention and become an important part of the [political agenda](https://www.vox.com/policy-and-politics/2017/3/29/15089618/trump-opioid-epidemic-executive-order). 

While the epidemic has also gained widespread media attention, coverage tends to focus on overall trends in deaths or for the [white population only](https://www.nytimes.com/2016/01/17/science/drug-overdoses-propel-rise-in-mortality-rates-of-young-whites.html). In a recent paper presented at [PAA 2017](https://paa.confex.com/paa/2017/webprogrampreliminary/Paper16497.html), we focused on differences in opioid mortality by race, to see how trends in underlying cause of death, opioid types and age patterns differ. 

![](/img/opiod_plots/fig1_nood_v_ci.png)
...
The combination of high opioid death rates, as well as a lower overall death rate compared to the black population, means that the impact is more noticeable in the white population. Opioid drug overdoses comprise some of the 'deaths of despair' (i.e. deaths due to drugs, alcohol and suicide) that [Case and Deaton](https://www.brookings.edu/bpea-articles/mortality-and-morbidity-in-the-21st-century/) attributed to causing an increase in the mortality rate in the non-Hispanic white population aged 45-54. 
...
![](/img/opiod_plots/paa_2017_fig.png)
...
![](/img/opiod_plots/fig9_t401_combos_v_ci.png)
...
![](/img/opiod_plots/fig5_asmr_race_all_errorbars.png)
![](/img/opiod_plots/fig7_t40_heroin_ci.png)
...
#### Notes
This post is based on a [paper](https://github.com/MJAlexander/opioid-mcd/blob/master/report/paa_2017_paper/paa.pdf) presented in the session on Trends and Causes of Adult Mortality in the United States
at [PAA 2017](https://paa.confex.com/paa/2017/webprogrampreliminary/Paper16497.html). It is joint work with [Magali Barbieri](http://www.demog.berkeley.edu/directories/profiles/barbieri.shtml) and [Mathew Kiang](https://mathewkiang.com/). All figures were derived from multiple cause of death data available from the [National Center for Health Statistics](https://www.cdc.gov/nchs/nvss/deaths.htm). The code to reproduce graphs from the raw data is available [here](https://github.com/MJAlexander/opioid-mcd).
