...
df <- read_csv("scholars.csv", col_types = cols_only("Name" = col_character(), "page" = col_character(), "Category" = col_character(), "Paper 1" = col_character(), "paper_1_link" = col_character(), "Paper 2" = col_character(), "paper_2_link" = col_character()))
